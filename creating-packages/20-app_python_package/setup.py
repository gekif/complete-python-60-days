...
setup(
  name = 'invoicing-pdf-fikar-maulana',         #* Your package will have this name
  ...
  author = 'Dzulfikar Maulana',                   # Your name
  author_email = 'dzulfikar.maulana@gmail.com',  # Your email
  url = 'https://github.com/gekif',              # Homepage of your library (e.g. github or your website)
